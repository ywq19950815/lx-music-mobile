...
async function main() {
  ...
  // 点击 Tab 4（我的音乐，x: 294, y: 846）
  console.log('Clicking Tab 4 (我的音乐)...')
  await ws.send('Input.dispatchMouseEvent', { type: 'mousePressed', x: 294, y: 846, button: 'left', clickCount: 1 })
  await ws.send('Input.dispatchMouseEvent', { type: 'mouseReleased', x: 294, y: 846, button: 'left', clickCount: 1 })
  await sleep(1000)
  ...
  console.log('Visible Texts on Tab 4:', texts.result.value)
  ...
  fs.writeFileSync('preview/shot_tab_4_dashboard.png', Buffer.from(shot.data, 'base64'))
  console.log('Saved preview/shot_tab_4_dashboard.png')
